    ...
    <div className={`bg-primary text-primary-foreground py-16 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <div className="mb-4">
              <span className="text-2xl font-bold">TechPremium</span>
            </div>
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              Tu tienda de confianza para accesorios Apple premium. Productos originales con garantía oficial.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20 text-center text-primary-foreground/60 text-sm">
          <p>&copy; 2025 TechPremium. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  )
